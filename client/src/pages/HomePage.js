  ...
  return (
    <>
      <Container>
        <Left>
          <Quote>
            A book is a <Bold>Gift</Bold> you open again and again
          </Quote>
          <SearchWrapper>
          ...
          <Photo>
            <img
              src={process.env.PUBLIC_URL + "/images/book-hand1.png"}
              alt="a hand holding some books"
            />
          </Photo>
        </Left>
        <Right>
          <Choose>
            Choose a book{" "}
            <AiOutlineRead size={25} style={{ marginTop: "10px" }} /> and{" "}
            <Bold>start reading</Bold>:
          </Choose>
          <BookWrapper>
            <Books />
          </BookWrapper>
